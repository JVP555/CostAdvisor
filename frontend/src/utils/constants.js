export const PIE_COLORS = ['#4fffb0','#74b9ff','#ffd166','#ff6b6b','#a29bfe','#fd79a8','#55efc4','#81ecec','#fab1a0'];
...
export const INCOTERMS = ['EXW','FCA','FOB','CFR','CIF','CPT','CIP','DPU','DAP','DDP','FAS'];
