      ...
      <div className="ca-modal" style={{ width: 460 }} onClick={e => e.stopPropagation()}>
        ...
        <div className="ca-modal-body" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          ...
          <div style={{ gridColumn: '1 / -1' }}>
            ...
            <input className="ca-input" placeholder="https://data-api.ecb.europa.eu/service/data/EXR/Q...."
                  ...
                  <tr key={p.id}>
                    ...
                    <td>
                      <span className={`ca-badge`} style={{
                        background: p.source_type === 'ecb' ? 'var(--accent2-dim)' : p.source_type === 'generic' ? 'var(--accent3-dim)' : 'var(--surface-hover)',
                        color: p.source_type === 'ecb' ? 'var(--accent2)' : p.source_type === 'generic' ? 'var(--accent3)' : 'var(--text-secondary)',
