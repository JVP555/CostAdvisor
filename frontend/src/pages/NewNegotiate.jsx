...
// (copied) Negotiation Brief for it. The brief body is keyed by costModelId so
// switching models gives it clean state.
export default function NewNegotiate() {
  ...
  if (!models.length) {
    return (
      <div className="ca-page ca-fade-in">
        <div className="ca-h1">Negotiation</div>
        <div className="ca-card" style={{ textAlign: 'center', padding: 48, color: 'var(--text-secondary)' }}>
          No cost models yet. Create a cost model with a formula to generate a negotiation brief.
        </div>
      </div>
    );
  }
...
function NegotiateBody({ costModelId, models, onSelectModel }) {
  ...
  return (
    <div className="ca-page ca-fade-in ca-print-page">
      {/* Header with model selector + print button */}
