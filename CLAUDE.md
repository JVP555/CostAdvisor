...
**Read this table alongside the Wave-3 refined backlog above** — several rows here (26, 27, 29, 30, 31, 32, 33) are the same work the teammate's SCRUM-70…156 tickets scope in more detail; where they disagree on blockers, the refined backlog is more current (it was written against the actual missing-drop state).
